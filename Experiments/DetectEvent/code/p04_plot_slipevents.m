...
for event_id = 1:size(T, 1)
    ...
    scale_y = 200/1e3;
    scale_len = 5; %[V]
    plot([scale_x, scale_x], [scale_y-(scale_len/ampnorm_AE)/2, scale_y+(scale_len/ampnorm_AE)/2], "-", "Color", "b", "LineWidth", 3);
...
%     end
    ...
    % figname = sprintf(figdir+"/p04_plot_event_FB03_%03d_event%02d.png", expr_id, event_id);
    figname = sprintf(figdir+"/p04_plot_event_FB03_%03d_event%02d.jpg", expr_id, event_id);
