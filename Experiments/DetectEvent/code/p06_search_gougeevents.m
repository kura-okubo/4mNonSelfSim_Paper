% 06 plot AE and strain to search foreshocks
clear all;
...
figdir = sprintf("../figure/p06_search_foreshock_FB03_%03d", expr_id);
if ~exist(figdir) mkdir(figdir); end


figname = sprintf(figdir+"/p06_search_foreshock_FB03_%03d_event%02d.png", expr_id, event_id);
