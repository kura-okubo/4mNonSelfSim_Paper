...
def gui_pick_arrival(fig, st_obs):
	...
	def plot_trace(trace_id):
		...
		ax1.set_ylabel('Amplitude [V]', color='k')
		...
		stnm = tr.stats.station
		ax1.set_title("{}\nevent{:04d} {} {} arrival time: {:4.5f} [ms]".format(titlestr, st_obs.foreshock_id, st_obs.event_type, stnm, tpick[stnm]))
	...
	def on_press_all(event):
		...
		if event.key == 'a': # modify pick time
			...
			ax1.set_title("{}\nevent{:04d} {} {} arrival time: {:4.5f} [ms] location done!".format(titlestr, st_obs.foreshock_id, st_obs.event_type, stnm, tpick[stnm]))

			datacase = st_obs.runID+"__{:04d}".format(st_obs.foreshock_id)
			...
			figname = st_obs.eventoutdir+"/errvar_contour__{}__{:04d}__iter__{:02d}.png".format(st_obs.runID, st_obs.foreshock_id, iter_pick)
			...
			ax1.set_title("{}\nevent{:04d} {} {} arrival time: {:4.5f} [ms] t_origin:{:4.2f}".format(titlestr, st_obs.foreshock_id, st_obs.event_type, stnm, tpick[stnm], T))
			...
			ax1.set_title("{}\nevent{:04d} {} {} arrival time: {:4.5f} [ms] save tpick done!".format(titlestr, st_obs.foreshock_id, st_obs.event_type, stnm, tpick[stnm]))
			plt.draw()
			...
			ax1.set_title("{}\nevent{:04d} {} {} arrival time: {:4.5f} [ms] pickfile removed.".format(titlestr, st_obs.foreshock_id, st_obs.event_type, stnm, tpick[stnm]))
			plt.draw()
	...
	fopickname = os.path.join(st_obs.eventoutdir, "tpick__{}__{:04d}.pickle".format(st_obs.runID, st_obs.foreshock_id))
	fotmpeventname = os.path.join(st_obs.eventoutdir, "tmp_eventloc__{}__{:04d}.pickle".format(st_obs.runID, st_obs.foreshock_id))
	foeventname = os.path.join(st_obs.eventoutdir, "eventloc__{}__{:04d}.pickle".format(st_obs.runID, st_obs.foreshock_id))
