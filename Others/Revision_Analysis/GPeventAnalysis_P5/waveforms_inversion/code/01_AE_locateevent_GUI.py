...
# - update 2024.06.26 change event set for the gouge events at G5
...
foreshock_eventset_P5 = [17,  23,  29,  33,  36,  42,  65,  80,  90,  93, 103, 106, 107, 108, 114, 115] # Ordinary, x=2750, exclude 56, 57, signal too large; 123 low S/N

for i, df_evt in df_expr.iterrows():
    # if not df_evt['foreshock_id']==20:
    if not df_evt['foreshock_id'] in foreshock_eventset_P5:
