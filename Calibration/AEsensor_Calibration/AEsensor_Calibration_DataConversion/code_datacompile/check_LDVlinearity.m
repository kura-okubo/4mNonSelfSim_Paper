...
D = importdata('../data/LDV_linearprog.csv');
...
% figdir_scatter = "../figure/linear_all";
% if ~isfolder(figdir_scatter); mkdir(figdir_scatter); end
...
for i = 1:9
    ...
    exportgraphics(gcf, figdir_scatter+sprintf("linearity_%dV.png",V(i)) , "Resolution", 150);
...
set(gcf, 'Color', 'w');
exportgraphics(gcf, "../figure/linearity_V100vsV200.png", "Resolution", 150);
