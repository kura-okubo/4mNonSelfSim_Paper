...
figdir="../figure/p04_slipslipvel_profile";
...
event_id = 29;
load(sprintf("../data/p01_slipandslipvel/FB03-%03d_slipvelocity_event%03d.mat", expr_id, event_id));
...
M = readtable(sprintf('../data/localslip_and_slipvel_fb03-%03d.csv', expr_id), 'VariableNamingRule', 'preserve');
...
gougeevent_ot = df_event.event_onset_time - Tstart; % Tstart is already shifted
